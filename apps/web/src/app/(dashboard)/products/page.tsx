  ...
  return (
    <div style={{ position: 'fixed', inset: 0, zIndex: 100, display: 'flex', alignItems: 'flex-start', justifyContent: 'center', padding: '20px', overflow: 'auto', background: 'rgba(0,0,0,0.75)', backdropFilter: 'blur(8px)' }}>
      <div className='prod-modal' style={{ width: '100%', maxWidth: '680px', background: 'var(--dax-bg)', border: '1px solid rgba(255,92,53,0.18)', borderRadius: '20px', overflow: 'hidden', boxShadow: '0 32px 80px rgba(0,0,0,0.7)', animation: 'modalOpen .25s cubic-bezier(.22,1,.36,1)', marginTop: '20px' }}>
        ...
        {/* Sub-tabs */}
        <div className='prod-tabs' style={{ display: 'flex', gap: '2px', padding: '12px 24px 0', borderBottom: '1px solid var(--dax-border)' }}>
          {TABS.map(t => (
        ...
        <div className='prod-modal-body' style={{ padding: '24px', maxHeight: '65vh', overflowY: 'auto' as const }}>
          ...
          {activeTab === 'basic' && (
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              <div className='prod-img-upload' style={{ display: 'grid', gridTemplateColumns: '1fr 200px', gap: '16px', alignItems: 'start' }}>
          ...
          {activeTab === 'pricing' && (
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              ...
              {parseFloat(form.price) > 0 && parseFloat(taxRate) > 0 && (
                <div style={{ padding: '11px 13px 13px', background: 'rgba(90,170,240,0.05)', border: '1px solid rgba(90,170,240,0.15)', borderRadius: '12px' }}>
...
export default function ProductsPage() {
  ...
  return (
    <div style={{ padding: '24px', maxWidth: '1300px', fontFamily: "'Inter','Outfit',system-ui,sans-serif" }}>
      ...
      {/* Header */}
      <div className='prod-header' style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '20px', flexWrap: 'wrap' as const, gap: '12px' }}>
        <div>
      ...
      {/* Filtros */}
      <div className='prod-filters' style={{ display: 'flex', gap: '10px', marginBottom: '20px', flexWrap: 'wrap' as const, alignItems: 'center' }}>
      ...
      <style>{`
        ...
        @media(max-width:768px){
          ...
          .prod-filters  { flex-wrap:wrap!important }
          ...
          .prod-modal-body { padding:16px!important; max-height:70vh!important }
          .prod-tabs     { overflow-x:auto!important; scrollbar-width:none!important }
          .prod-form-2col { grid-template-columns:1fr!important }
          .prod-img-upload { grid-template-columns:1fr!important }
        }
