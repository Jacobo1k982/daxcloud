...
function ProductFormModal({ form, setForm, editId, onSave, onClose, saving, error, categories }: any) {
  ...
  return (
    <div style={{ position: 'fixed', inset: 0, zIndex: 100, display: 'flex', alignItems: 'flex-start', justifyContent: 'center', padding: '20px', overflow: 'auto', background: 'var(--dax-overlay)', backdropFilter: 'blur(8px)' }}>
      <div className='prod-modal' style={{ width: '100%', maxWidth: '680px', background: 'var(--dax-bg)', border: '1px solid rgba(255,92,53,0.18)', borderRadius: '20px', overflow: 'hidden', boxShadow: '0 32px 80px rgba(0,0,0,0.7)', animation: 'modalOpen .25s cubic-bezier(.22,1,.36,1)', marginTop: '20px' }}>
        <div style={{ position: 'relative' }}>
        ...
        {/* Sub-tabs */}
        <div className='prod-tabs' style={{ display: 'flex', gap: '2px', padding: '12px 24px 0', borderBottom: '1px solid rgba(255,255,255,0.07)' }}>
          {TABS.map(t => (
        ...
        {/* Body */}
        <div className='prod-modal-body' style={{ padding: '24px', maxHeight: '65vh', overflowY: 'auto' as const }}>

          {/* ── GENERAL ── */}
          {activeTab === 'basic' && (
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              <div className='prod-img-grid' style={{ display: 'grid', gridTemplateColumns: '1fr 200px', gap: '16px', alignItems: 'start' }}>
...
export default function ProductsPage() {
  ...
  return (
    <div style={{ padding: 'clamp(14px,3vw,24px)', maxWidth: '1300px', fontFamily: "'Inter','Outfit',system-ui,sans-serif" }}>

      {/* Header */}
      <div className='prod-header' style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '20px', flexWrap: 'wrap', gap: '12px' }}>
        <div>
      ...
      {/* Stats */}
      <div className='prod-stats' style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: '10px', marginBottom: '20px' }}>
        {[
      ...
      {/* Filtros */}
      <div className='prod-filters' style={{ display: 'flex', gap: '10px', marginBottom: '20px', flexWrap: 'wrap', alignItems: 'center' }}>
        <div className='prod-search' style={{ position: 'relative', flex: 1, minWidth: '200px' }}>
      ...
      {isLoading ? (
        ...
        <div className='prod-grid' style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill,minmax(155px,1fr))', gap: '12px' }}>
      ...
      <style>{`
        ...
        @media(max-width:768px){
          ...
          .prod-header button { width:100%!important; justify-content:center!important }
          .prod-stats    { grid-template-columns:repeat(2,1fr)!important }
          .prod-filters  { flex-direction:column!important; align-items:stretch!important }
          .prod-search   { min-width:0!important; width:100%!important }
          .prod-grid     { grid-template-columns:repeat(2,1fr)!important; gap:10px!important }
          .prod-modal    { margin:10px!important; max-width:calc(100vw - 20px)!important; border-radius:16px!important }
          .prod-modal-body { padding:16px!important; max-height:72vh!important }
          .prod-tabs     { overflow-x:auto!important; scrollbar-width:none!important; -webkit-overflow-scrolling:touch!important }
